...
var AreaChartComponent = function (props) { return (React.createElement(chart_container_1.default, __assign({}, props),
    React.createElement(recharts_1.LineChart, { data: props.chartData, margin: { top: 0, right: 0, left: 0, bottom: 35 } },
        ...
        props.lines.map(function (line, i) { return React.createElement(recharts_1.Line, __assign({ key: i }, line)); })))); };
