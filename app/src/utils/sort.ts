...
export function generateDateSort(param: string, format: string = 'YYYY-MM-DD'): (a: any, b: any) => number {
...
export function generateNumberSort(param: string): (a: any, b: any) => number {
