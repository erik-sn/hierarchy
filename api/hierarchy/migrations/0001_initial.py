# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-05-09 22:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.TextField(db_column='name')),
                ('description', models.TextField(blank=True, db_column='description')),
                ('useTime', models.BooleanField(db_column='use_time')),
                ('useFrom', models.BooleanField(db_column='use_from')),
                ('fromDefaultLength', models.IntegerField(blank=True, db_column='from_default_length')),
                ('fromDefaultType', models.TextField(blank=True, db_column='from_default_type')),
                ('useTo', models.BooleanField(db_column='use_to')),
                ('toDefaultLength', models.IntegerField(blank=True, db_column='to_default_length')),
                ('toDefaultType', models.TextField(blank=True, db_column='to_default_type')),
                ('endpoint', models.TextField(db_column='endpoint')),
                ('useEmail', models.BooleanField(db_column='use_email')),
                ('active', models.BooleanField(db_column='active')),
                ('department', models.ManyToManyField(to='hierarchy.Department')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='id', primary_key=True, serialize=False)),
                ('specName', models.TextField(db_column='specname')),
                ...
                ('columnoffset', models.IntegerField(db_column='column_offset', default=1)),
                ('rowoffset', models.IntegerField(db_column='row_offset', default=0)),
                ('machine', models.ForeignKey(db_column='machineid', on_delete=django.db.models.deletion.DO_NOTHING, to='hierarchy.Machine')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='report',
            name='options',
            field=models.ManyToManyField(to='hierarchy.ReportOptions'),
        ),
        migrations.AddField(
            model_name='part',
            name='position',
